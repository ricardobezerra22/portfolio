    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 px-4 bg-black/30">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          >
            {t('home.featured.projects').map((project: any, index: number) => (
              <a 
                href={project.link}
                target="_blank"
                ...
                >
                  <div className="relative h-48 bg-purple-500/10">
                    ...
                    <Image
                      ...
                      fill
                      className={`object-cover transition-opacity duration-300 ${loadedImages[project.title] ? 'opacity-100' : 'opacity-0'}`}
                      onLoad={() => handleImageLoad(project.title)}
                      onError={() => handleImageLoad(project.title)}
