...
import { MoonIcon, SunIcon, GlobeIcon, Menu, X, ChevronDown } from "lucide-react";
  ...
  return (
    <header 
      className={`fixed w-full top-0 z-50 transition-all duration-300 ${
        scrolled ? "bg-black/90 backdrop-blur-lg py-4 shadow-lg" : "bg-transparent py-6"
      }`}
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
            ...
            >
              <span className="relative">
                ...
                <span className={`absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-400 transition-all duration-300 
                              group-hover:w-full ${pathname === item.href ? "w-full" : ""}`} />
              </span>
            </Link>
          ))}
        </nav>
        ...
        <div className="flex items-center space-x-3">
          <div className="flex items-center bg-purple-500/10 rounded-full p-1">
            ...
            >
              <div className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 px-3 py-1.5 
            ...
            <div className="relative" ref={langMenuRef}>
              ...
              {/* Language Dropdown */}
              {isLangMenuOpen && (
                <div className="absolute right-0 mt-2 w-48 rounded-lg bg-black/95 backdrop-blur-md 
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <nav className="container mx-auto px-4 py-4 flex flex-col space-y-2 bg-black/95 backdrop-blur-lg 
